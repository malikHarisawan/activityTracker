APP_CATEGORIES = {
    "Software Development": {
        "apps": ["Visual Studio Code", "stackoverflow.com","WindowsTerminal.exe", "Microsoft Visual Studio 2022","github.com"],
    ...
    "Miscellaneous": {
        "apps": [],
        "description": "Applications without specific category"
    }
}